...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	DATASET="keywords-230701-250931_v3_train,keyword_merge_all_v2,shenhe-240601-250531_v5_keywords_llmverify,tongbao_chouyang_v2,zhongzi-nlpsimilarity-250613_v3_keywords,zhongzi-nlpsimilarity-250929_v3_keywords"
        # 使用环境变量传递参数并执行训练脚本
