...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	DATASET="keywords-230701-250931_v4_train,keywords-251001-251208_v4,qunliaokey_241125-250313_v2,shenhe-240601-250531_v5_keywords_llmverify,tongbao_chouyang_v2,zhongzi-nlpsimilarity-250613_v2_keywords_juhe_qwen3,zhongzi-nlpsimilarity-250929_v2_keywords_juhe_qwen3"
        # 使用环境变量传递参数并执行训练脚本
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
	...
	for checkpoint in 5000 4000; do
