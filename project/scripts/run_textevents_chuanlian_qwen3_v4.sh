...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	DATASET="Chinese-Qwen3-235B-2507-Distill-data-110k-SFT,rqunliaoke_qwen235b-process_0130,ragkeyword_260101_260110_processed_train_cot,qunliaokey_241125-250313_v3_juhe_qwen3"
        # 使用环境变量传递参数并执行训练脚本
