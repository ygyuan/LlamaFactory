...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	MODEL_NAME_OR_PATH="/apdcephfs_hzlf/share_303924399/huggingface/Qwen3.5-0.8B"
	...
	# DATASET="largellm_260101_260126_v3_train_juhe_qwen3,largellm_250801_251231_v1_juhe_qwen3,Infinity-Instruct_7M_core_train,shenhe-240601-250531_v6_juhe_qwen3,qunliaokey_241125-250313_v3_juhe_qwen3,zhongzi_250929_v3_keywords_juhe_qwen3"
	DATASET="largellm_250801_260126_v4_train_juhe_qwen3,keywords_random50w_v7_train_juhe_qwen3,Infinity-Instruct_7M_core_train,shenhe-240601-250531_v6_juhe_qwen3,qunliaokey_241125-250313_v3_juhe_qwen3"
	# DATASET="shenhe-240601-250531_v6_juhe_qwen3"
        # 使用环境变量传递参数并执行训练脚本
	...
	TEMPLATE=${TEMPLATE} DATASET=${DATASET} \
        bash project/scripts/run_textevents_train_qwen3_5_1b_full_accelarate.sh
    done
fi
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
	...
	for checkpoint in 5000 10000; do
            bash project/scripts/run_textevents_eval_qwen3_5_1b_prompt1.sh ${x} ${checkpoint} 1 1
        done
    done
fi
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    for x in train_all_v11; do
        for checkpoint in 5000 10000; do
            bash project/scripts/run_textevents_eval_qwen3_5_1b_prompt1.sh ${x} ${checkpoint} 3 3
        done
    done
fi
