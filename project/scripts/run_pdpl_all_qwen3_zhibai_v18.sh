...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	SAVE_STEPS=100
	TASK_NAME=${x}
	MODEL_NAME_OR_PATH="/apdcephfs_hzlf/share_303924399/huggingface/sft-qwen3-fangwusha_train_all_v16/checkpoint-7500"
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
	...
	for checkpoint in 9600 7200 4800 2400; do
