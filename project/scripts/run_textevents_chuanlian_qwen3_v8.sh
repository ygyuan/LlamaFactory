...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	DATASET="Chinese-Qwen3-235B-2507-Distill-data-110k-SFT,largellm_260101_260126_v3_train_juhe_qwen3,largellm_250801_251231_v1_juhe_qwen3,Infinity-Instruct_7M_core,keywords-251001-251208_v6_juhe_qwen3,keywords-230701-250931_v6_train_juhe_qwen3,shenhe-240601-250531_v6_juhe_qwen3,qunliaokey_241125-250313_v3_juhe_qwen3,zhongzi_250929_v3_keywords_juhe_qwen3"
        # 使用环境变量传递参数并执行训练脚本
