...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
	...
	SAVE_STEPS=5000
	TASK_NAME=${x}
	MODEL_NAME_OR_PATH="/group/40184/yougenyuan/tools/huggingface/Qwen3Fangwusha14B/checkpoint-15000"
	FINETUNING_TYPE="lora"
	TEMPLATE="qwen3"
	DATASET="train_all_v10_juhe_qwen3"
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    echo "start stage ${stage}, stop stage ${stop_stage}"
    for x in train_all_v11; do
        for checkpoint in 15000 10000 5000; do
